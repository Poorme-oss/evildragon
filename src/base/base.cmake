...
if (WITH_HTTP)
    ...
    add_definitions(/Devildragon_FEATURE_HTTP)
    add_definitions(/Devildragon_FEATURE_API)
else()
    set(HEADERS_BASE_HTTP "")
    set(SOURCES_BASE_HTTP "")
    remove_definitions(/Devildragon_FEATURE_HTTP)
    remove_definitions(/Devildragon_FEATURE_API)
endif()
...
if (WITH_ENV_VARS)
    add_definitions(/Devildragon_FEATURE_ENV)
else()
    remove_definitions(/Devildragon_FEATURE_ENV)
endif()
