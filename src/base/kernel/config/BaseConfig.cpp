...
bool evildragon::BaseConfig::read(const IJsonReader &reader, const char *fileName)
{
    m_fileName = fileName;
...
bool evildragon::BaseConfig::save()
{
...
void evildragon::BaseConfig::printVersions()
{
    char buf[256] = { 0 };
...
#   if defined(evildragon_FEATURE_TLS)
    {
...
#   if defined(evildragon_FEATURE_HWLOC)
...
void evildragon::BaseConfig::setVerbose(const rapidjson::Value &value)
{
    if (value.IsBool()) {
