...
#ifdef evildragon_FEATURE_EMBEDDED_CONFIG
...
{
public:
    evildragon_DISABLE_COPY_MOVE_DEFAULT(BasePrivate)
...
evildragon::Base::Base(Process *process)
    : d_ptr(new BasePrivate(process))
{
}


evildragon::Base::~Base()
{
    delete d_ptr;
}


bool evildragon::Base::isReady() const
{
    return d_ptr->config != nullptr;
}


int evildragon::Base::init()
{
#   ifdef evildragon_FEATURE_API
...
evildragon::Api *evildragon::Base::api() const
{
...
bool evildragon::Base::isBackground() const
{
    return d_ptr->config && d_ptr->config->isBackground();
}


bool evildragon::Base::reload(const rapidjson::Value &json)
{
...
evildragon::Config *evildragon::Base::config() const
{
...
void evildragon::Base::addListener(IBaseListener *listener)
{
    d_ptr->listeners.push_back(listener);
}


void evildragon::Base::onFileChanged(const String &fileName)
{
...
#ifdef evildragon_FEATURE_API
void evildragon::Base::onRequest(IApiRequest &request)
{
