...
char *evildragon::Platform::createUserAgent()
{
...
bool evildragon::Platform::setThreadAffinity(uint64_t cpu_id)
{
...
void evildragon::Platform::setProcessPriority(int priority)
{
    if (priority == -1) {
        return;
    }
...
void evildragon::Platform::setThreadPriority(int priority)
{
    if (priority == -1) {
        return;
    }
...
bool evildragon::Platform::isOnBatteryPower()
{
