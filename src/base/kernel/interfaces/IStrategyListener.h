...
#ifndef evildragon_ISTRATEGYLISTENER_H
#define evildragon_ISTRATEGYLISTENER_H
...
{
public:
    evildragon_DISABLE_COPY_MOVE(IStrategyListener);
...
#endif // evildragon_ISTRATEGYLISTENER_H
