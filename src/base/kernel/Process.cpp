...
evildragon::Process::Process(int argc, char **argv) :
...
evildragon::String evildragon::Process::exepath()
{
    size_t size = sizeof(pathBuf);
...
evildragon::String evildragon::Process::location(Location location, const char *fileName)
{
