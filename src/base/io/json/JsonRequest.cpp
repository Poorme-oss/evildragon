...
rapidjson::Document evildragon::JsonRequest::create(int64_t id, const char *method)
{
...
void evildragon::JsonRequest::create(rapidjson::Document &doc, int64_t id, const char *method, rapidjson::Value &params)
{
    using namespace rapidjson;
    auto &allocator = doc.GetAllocator();
