...
#ifndef evildragon_LOG_H
#define evildragon_LOG_H
...
#define LOG_EMERG(x, ...)   evildragon::Log::print(evildragon::Log::EMERG,   x, ##__VA_ARGS__)
#define LOG_ALERT(x, ...)   evildragon::Log::print(evildragon::Log::ALERT,   x, ##__VA_ARGS__)
#define LOG_CRIT(x, ...)    evildragon::Log::print(evildragon::Log::CRIT,    x, ##__VA_ARGS__)
#define LOG_ERR(x, ...)     evildragon::Log::print(evildragon::Log::ERR,     x, ##__VA_ARGS__)
#define LOG_WARN(x, ...)    evildragon::Log::print(evildragon::Log::WARNING, x, ##__VA_ARGS__)
#define LOG_NOTICE(x, ...)  evildragon::Log::print(evildragon::Log::NOTICE,  x, ##__VA_ARGS__)
#define LOG_INFO(x, ...)    evildragon::Log::print(evildragon::Log::INFO,    x, ##__VA_ARGS__)
#define LOG_VERBOSE(x, ...) if (evildragon::Log::verbose() > 0) { evildragon::Log::print(evildragon::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V1(x, ...)      if (evildragon::Log::verbose() > 0) { evildragon::Log::print(evildragon::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V2(x, ...)      if (evildragon::Log::verbose() > 1) { evildragon::Log::print(evildragon::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V3(x, ...)      if (evildragon::Log::verbose() > 2) { evildragon::Log::print(evildragon::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V4(x, ...)      if (evildragon::Log::verbose() > 3) { evildragon::Log::print(evildragon::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V5(x, ...)      if (evildragon::Log::verbose() > 4) { evildragon::Log::print(evildragon::Log::INFO, x, ##__VA_ARGS__); }

#ifdef APP_DEBUG
#   define LOG_DEBUG(x, ...) evildragon::Log::print(evildragon::Log::DEBUG, x, ##__VA_ARGS__)
#else
#   define LOG_DEBUG(x, ...)
#endif

#if defined(APP_DEBUG) || defined(APP_DEVEL)
#   define LOG_DEBUG_ERR(x, ...)  evildragon::Log::print(evildragon::Log::ERR,     x, ##__VA_ARGS__)
#   define LOG_DEBUG_WARN(x, ...) evildragon::Log::print(evildragon::Log::WARNING, x, ##__VA_ARGS__)
#else
