...
evildragon::ConsoleLog::ConsoleLog(const Title &title)
{
    if (!isSupported()) {
        Log::setColors(false);
        return;
...
evildragon::ConsoleLog::~ConsoleLog()
{
    Handle::close(m_tty);
}


void evildragon::ConsoleLog::print(int, const char *line, size_t, size_t size, bool colors)
{
...
bool evildragon::ConsoleLog::isSupported() const
{
...
#ifdef evildragon_OS_WIN
bool evildragon::ConsoleLog::isWritable() const
{
