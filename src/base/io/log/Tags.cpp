...
const char *evildragon::Tags::config()
{
...
const char *evildragon::Tags::network()
{
...
const char *evildragon::Tags::signal()
{
...
#ifdef evildragon_MINER_PROJECT
const char *evildragon::Tags::cpu()
{
...
const char *evildragon::Tags::miner()
{
...
const char *evildragon::Tags::randomx()
{
...
const char *evildragon::Tags::proxy()
{
...
const char *evildragon::Tags::nvidia()
{
...
const char *evildragon::Tags::opencl()
{
