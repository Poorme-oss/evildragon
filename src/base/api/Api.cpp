...
void evildragon::Api::request(const HttpData &req)
{
...
void evildragon::Api::onConfigChanged(Config *config, Config *previousConfig)
{
...
void evildragon::Api::exec(IApiRequest &request)
{
    using namespace rapidjson;
...
#       endif
#       ifdef evildragon_FEATURE_LIBCPUID
...
void evildragon::Api::genId(const String &id)
{
...
void evildragon::Api::genWorkerId(const String &id)
{
