...
evildragon::Httpd::Httpd(Base *base) :
    m_base(base)
{
...
evildragon::Httpd::~Httpd() = default;


bool evildragon::Httpd::start()
{
...
void evildragon::Httpd::onConfigChanged(Config *config, Config *previousConfig)
{
...
void evildragon::Httpd::onHttpData(const HttpData &data)
{
...
int evildragon::Httpd::auth(const HttpData &req) const
{
