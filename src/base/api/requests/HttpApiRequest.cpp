...
evildragon::HttpApiRequest::HttpApiRequest(const HttpData &req, bool restricted) :
...
bool evildragon::HttpApiRequest::accept()
{
...
const rapidjson::Value &evildragon::HttpApiRequest::json() const
{
    if (type() == REQ_JSON_RPC) {
...
evildragon::IApiRequest::Method evildragon::HttpApiRequest::method() const
{
    return static_cast<IApiRequest::Method>(m_req.method);
}


void evildragon::HttpApiRequest::done(int status)
{
...
void evildragon::HttpApiRequest::setRpcError(int code, const char *message)
{
    using namespace rapidjson;
    auto &allocator = doc().GetAllocator();
...
void evildragon::HttpApiRequest::setRpcResult(rapidjson::Value &result)
{
    rpcDone(kResult, result);
}


void evildragon::HttpApiRequest::rpcDone(const char *key, rapidjson::Value &value)
{
    ApiRequest::done(0);
