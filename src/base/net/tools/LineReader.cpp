...
evildragon::LineReader::~LineReader()
{
    NetBuffer::release(m_buf);
}


void evildragon::LineReader::parse(char *data, size_t size)
{
...
void evildragon::LineReader::reset()
{
    if (m_buf) {
        NetBuffer::release(m_buf);
        m_buf = nullptr;
...
void evildragon::LineReader::add(const char *data, size_t size)
{
...
void evildragon::LineReader::getline(char *data, size_t size)
{
    char *end        = nullptr;
    char *start      = data;
