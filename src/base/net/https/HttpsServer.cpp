...
evildragon::HttpsServer::HttpsServer(const std::shared_ptr<IHttpListener> &listener) :
    m_listener(listener)
{
}


evildragon::HttpsServer::~HttpsServer()
{
...
bool evildragon::HttpsServer::setTls(const TlsConfig &config)
{
...
void evildragon::HttpsServer::onConnection(uv_stream_t *stream, uint16_t)
{
...
void evildragon::HttpsServer::onRead(uv_stream_t *stream, ssize_t nread, const uv_buf_t *buf)
{
