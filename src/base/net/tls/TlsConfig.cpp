 ...
 */
evildragon::TlsConfig::TlsConfig(const rapidjson::Value &value)
{
    if (value.IsObject()) {
...
bool evildragon::TlsConfig::generate(const char *commonName)
{
    TlsGen gen;
...
rapidjson::Value evildragon::TlsConfig::toJSON(rapidjson::Document &doc) const
{
...
void evildragon::TlsConfig::setProtocols(const char *protocols)
{
...
void evildragon::TlsConfig::setProtocols(const rapidjson::Value &protocols)
{
    m_protocols = 0;
