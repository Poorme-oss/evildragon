...
evildragon::ProxyUrl::ProxyUrl(const rapidjson::Value &value)
{
    m_port = 0;
...
const evildragon::String &evildragon::ProxyUrl::host() const
{
    return m_host.isNull() && isValid() ? kLocalhost : m_host;
}


rapidjson::Value evildragon::ProxyUrl::toJSON(rapidjson::Document &doc) const
{
