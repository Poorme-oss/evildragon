...
#ifndef evildragon_SINGLEPOOLSTRATEGY_H
#define evildragon_SINGLEPOOLSTRATEGY_H
...
{
public:
    evildragon_DISABLE_COPY_MOVE_DEFAULT(SinglePoolStrategy)
...
#endif /* evildragon_SINGLEPOOLSTRATEGY_H */
