...
#ifndef evildragon_FAILOVERSTRATEGY_H
#define evildragon_FAILOVERSTRATEGY_H
...
{
public:
    evildragon_DISABLE_COPY_MOVE_DEFAULT(FailoverStrategy)
...
#endif /* evildragon_FAILOVERSTRATEGY_H */
