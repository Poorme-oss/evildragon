...
#ifndef evildragon_ETHSTRATUMCLIENT_H
#define evildragon_ETHSTRATUMCLIENT_H
...
{
public:
    evildragon_DISABLE_COPY_MOVE_DEFAULT(EthStratumClient)
...
#endif /* evildragon_ETHSTRATUMCLIENT_H */
