...
#ifndef evildragon_SELFSELECTCLIENT_H
#define evildragon_SELFSELECTCLIENT_H
...
{
public:
    evildragon_DISABLE_COPY_MOVE_DEFAULT(SelfSelectClient)
...
#endif /* evildragon_SELFSELECTCLIENT_H */
