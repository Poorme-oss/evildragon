...
evildragon::Algorithm::Id evildragon::Coin::algorithm(uint8_t blobVersion) const
{
    switch (id()) {
    case MONERO:
...
const char *evildragon::Coin::name() const
{
...
rapidjson::Value evildragon::Coin::toJSON() const
{
...
evildragon::Coin::Id evildragon::Coin::parse(const char *name)
{
