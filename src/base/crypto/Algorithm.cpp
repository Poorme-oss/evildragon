...
evildragon::Algorithm::Algorithm(const rapidjson::Value &value) :
    m_id(parse(value.GetString()))
{
}


rapidjson::Value evildragon::Algorithm::toJSON() const
{
...
rapidjson::Value evildragon::Algorithm::toJSON(rapidjson::Document &) const
{
    return toJSON();
}


size_t evildragon::Algorithm::l2() const
{
#   ifdef evildragon_ALGO_RANDOMX
    switch (m_id) {
    case RX_0:
...
size_t evildragon::Algorithm::l3() const
{
...
uint32_t evildragon::Algorithm::maxIntensity() const
{
#   ifdef evildragon_ALGO_RANDOMX
    if (family() == RANDOM_X) {
        return 1;
...
evildragon::Algorithm::Family evildragon::Algorithm::family(Id id)
{
    switch (id) {
    case CN_0:
    case CN_1:
...
evildragon::Algorithm::Id evildragon::Algorithm::parse(const char *name)
{
...
const char *evildragon::Algorithm::name(bool shortName) const
{
    for (const AlgoName &item : algorithm_names) {
        if (item.id == m_id) {
