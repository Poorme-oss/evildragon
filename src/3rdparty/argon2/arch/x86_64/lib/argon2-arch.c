...
void argon2_get_impl_list(argon2_impl_list *list)
{
    static const argon2_impl IMPLS[] = {
        ...
        { "SSE2",       evildragon_ar2_check_sse2,     evildragon_ar2_fill_segment_sse2 },
        { "SSSE3",      evildragon_ar2_check_ssse3,    evildragon_ar2_fill_segment_ssse3 },
        { "XOP",        evildragon_ar2_check_xop,      evildragon_ar2_fill_segment_xop },
        { "AVX2",       evildragon_ar2_check_avx2,     evildragon_ar2_fill_segment_avx2 },
        { "AVX-512F",   evildragon_ar2_check_avx512f,  evildragon_ar2_fill_segment_avx512f },
    };
