...
#ifndef evildragon_WORKERS_H
#define evildragon_WORKERS_H
...
{
public:
    evildragon_DISABLE_COPY_MOVE(Workers)
...
template<class T>
void evildragon::Workers<T>::jobEarlyNotification(const Job& job)
{
