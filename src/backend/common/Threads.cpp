...
template <class T>
const T &evildragon::Threads<T>::get(const String &profileName) const
{
    static T empty;
...
template <class T>
size_t evildragon::Threads<T>::read(const rapidjson::Value &value)
{
...
template <class T>
evildragon::String evildragon::Threads<T>::profileName(const Algorithm &algorithm, bool strict) const
{
...
template <class T>
void evildragon::Threads<T>::toJSON(rapidjson::Value &out, rapidjson::Document &doc) const
{
    using namespace rapidjson;
