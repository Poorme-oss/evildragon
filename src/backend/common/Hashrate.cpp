...
evildragon::Hashrate::Hashrate(size_t threads) :
    m_threads(threads)
{
...
double evildragon::Hashrate::calc(size_t ms) const
{
    double result = 0.0;
    double data;
...
double evildragon::Hashrate::calc(size_t threadId, size_t ms) const
{
    ...
    const uint64_t timeStampLimit = evildragon::Chrono::highResolutionMSecs() - ms;
...
void evildragon::Hashrate::add(size_t threadId, uint64_t count, uint64_t timestamp)
{
...
const char *evildragon::Hashrate::format(double h, char *buf, size_t size)
{
    return ::format(h, buf, size);
}


rapidjson::Value evildragon::Hashrate::normalize(double d)
{
...
rapidjson::Value evildragon::Hashrate::toJSON(rapidjson::Document &doc) const
{
...
rapidjson::Value evildragon::Hashrate::toJSON(size_t threadId, rapidjson::Document &doc) const
{
    using namespace rapidjson;
    auto &allocator = doc.GetAllocator();
