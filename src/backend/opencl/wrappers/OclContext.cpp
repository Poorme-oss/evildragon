...
evildragon::OclContext::OclContext(const OclDevice &device)
{
...
evildragon::OclContext::~OclContext()
{
    if (m_ctx) {
...
bool evildragon::OclContext::init(const std::vector<OclDevice> &devices, std::vector<OclLaunchData> &threads)
{
    if (!m_ctx) {
