...
std::vector<evildragon::OclPlatform> evildragon::OclPlatform::get()
{
...
void evildragon::OclPlatform::print()
{
...
rapidjson::Value evildragon::OclPlatform::toJSON(rapidjson::Document &doc) const
{
...
std::vector<evildragon::OclDevice> evildragon::OclPlatform::devices() const
{
...
evildragon::String evildragon::OclPlatform::extensions() const
{
    return OclLib::getString(id(), CL_PLATFORM_EXTENSIONS);
}


evildragon::String evildragon::OclPlatform::name() const
{
    return OclLib::getString(id(), CL_PLATFORM_NAME);
}


evildragon::String evildragon::OclPlatform::profile() const
{
    return OclLib::getString(id(), CL_PLATFORM_PROFILE);
}


evildragon::String evildragon::OclPlatform::vendor() const
{
    return OclLib::getString(id(), CL_PLATFORM_VENDOR);
}


evildragon::String evildragon::OclPlatform::version() const
{
