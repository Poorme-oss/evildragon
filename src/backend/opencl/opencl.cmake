if (BUILD_STATIC AND evildragon_OS_UNIX AND WITH_OPENCL)
...
if (WITH_OPENCL)
    ...
    add_definitions(/Devildragon_FEATURE_OPENCL)
    ...
    if (WITH_STRICT_CACHE)
        add_definitions(/Devildragon_STRICT_OPENCL_CACHE)
    else()
        remove_definitions(/Devildragon_STRICT_OPENCL_CACHE)
    endif()

    if (WITH_INTERLEAVE_DEBUG_LOG)
        add_definitions(/Devildragon_INTERLEAVE_DEBUG)
    endif()

    if (WITH_ADL AND (evildragon_OS_WIN OR evildragon_OS_LINUX))
        add_definitions(/Devildragon_FEATURE_ADL)
       ...
       remove_definitions(/Devildragon_FEATURE_ADL)
    endif()
else()
    remove_definitions(/Devildragon_FEATURE_OPENCL)
    remove_definitions(/Devildragon_FEATURE_ADL)
