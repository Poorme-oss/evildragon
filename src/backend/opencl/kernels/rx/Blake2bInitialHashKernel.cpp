...
void evildragon::Blake2bInitialHashKernel::enqueue(cl_command_queue queue, size_t threads)
{
...
void evildragon::Blake2bInitialHashKernel::setArgs(cl_mem out, cl_mem blockTemplate)
{
...
void evildragon::Blake2bInitialHashKernel::setBlobSize(size_t size)
{
...
void evildragon::Blake2bInitialHashKernel::setNonce(uint32_t nonce)
{
