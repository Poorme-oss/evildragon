...
evildragon::OclRxBaseRunner::OclRxBaseRunner(size_t index, const OclLaunchData &data) : OclBaseRunner(index, data)
{
...
evildragon::OclRxBaseRunner::~OclRxBaseRunner()
{
...
void evildragon::OclRxBaseRunner::run(uint32_t nonce, uint32_t *hashOutput)
{
...
void evildragon::OclRxBaseRunner::set(const Job &job, uint8_t *blob)
{
...
size_t evildragon::OclRxBaseRunner::bufferSize() const
{
...
void evildragon::OclRxBaseRunner::build()
{
    OclBaseRunner::build();
...
void evildragon::OclRxBaseRunner::init()
{
    OclBaseRunner::init();
