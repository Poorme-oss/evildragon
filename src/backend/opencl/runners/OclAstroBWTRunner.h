...
#ifndef evildragon_OCLASTROBWTRUNNER_H
#define evildragon_OCLASTROBWTRUNNER_H
...
public:
    ...
    evildragon_DISABLE_COPY_MOVE_DEFAULT(OclAstroBWTRunner)
...
#endif // evildragon_OCLASTROBWTRUNNER_H
