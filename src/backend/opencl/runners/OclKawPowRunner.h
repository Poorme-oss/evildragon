...
#ifndef evildragon_OCLKAWPOWRUNNER_H
#define evildragon_OCLKAWPOWRUNNER_H
...
{
public:
    evildragon_DISABLE_COPY_MOVE_DEFAULT(OclKawPowRunner)
...
#endif // evildragon_OCLKAWPOWRUNNER_H
