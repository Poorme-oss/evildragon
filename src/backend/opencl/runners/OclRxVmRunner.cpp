...
evildragon::OclRxVmRunner::OclRxVmRunner(size_t index, const OclLaunchData &data) : OclRxBaseRunner(index, data)
{
}


evildragon::OclRxVmRunner::~OclRxVmRunner()
{
    delete m_init_vm;
    delete m_execute_vm;
...
size_t evildragon::OclRxVmRunner::bufferSize() const
{
    return OclRxBaseRunner::bufferSize() + (align(2560 * m_intensity));
}


void evildragon::OclRxVmRunner::build()
{
...
void evildragon::OclRxVmRunner::execute(uint32_t iteration)
{
...
void evildragon::OclRxVmRunner::init()
{
