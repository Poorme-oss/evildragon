...
evildragon::OclAstroBWTRunner::OclAstroBWTRunner(size_t index, const OclLaunchData &data) : OclBaseRunner(index, data)
{
...
evildragon::OclAstroBWTRunner::~OclAstroBWTRunner()
{
...
size_t evildragon::OclAstroBWTRunner::bufferSize() const
{
...
void evildragon::OclAstroBWTRunner::run(uint32_t nonce, uint32_t *hashOutput)
{
...
void evildragon::OclAstroBWTRunner::set(const Job &job, uint8_t *blob)
{
...
void evildragon::OclAstroBWTRunner::build()
{
    OclBaseRunner::build();
...
void evildragon::OclAstroBWTRunner::init()
{
    OclBaseRunner::init();
