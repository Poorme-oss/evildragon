...
evildragon::OclCnRunner::OclCnRunner(size_t index, const OclLaunchData &data) : OclBaseRunner(index, data)
{
...
evildragon::OclCnRunner::~OclCnRunner()
{
    delete m_cn0;
    delete m_cn1;
    delete m_cn2;
...
size_t evildragon::OclCnRunner::bufferSize() const
{
...
void evildragon::OclCnRunner::run(uint32_t nonce, uint32_t *hashOutput)
{
...
void evildragon::OclCnRunner::set(const Job &job, uint8_t *blob)
{
...
void evildragon::OclCnRunner::build()
{
    OclBaseRunner::build();
...
void evildragon::OclCnRunner::init()
{
    OclBaseRunner::init();
