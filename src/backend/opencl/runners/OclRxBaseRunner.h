...
#ifndef evildragon_OCLRXBASERUNNER_H
#define evildragon_OCLRXBASERUNNER_H
...
{
public:
    evildragon_DISABLE_COPY_MOVE_DEFAULT(OclRxBaseRunner)
...
#endif // evildragon_OCLRXBASERUNNER_H
