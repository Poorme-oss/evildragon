...
evildragon::OclRxJitRunner::OclRxJitRunner(size_t index, const OclLaunchData &data) : OclRxBaseRunner(index, data)
{
}


evildragon::OclRxJitRunner::~OclRxJitRunner()
{
...
void evildragon::OclRxJitRunner::execute(uint32_t iteration)
{
...
void evildragon::OclRxJitRunner::init()
{
...
bool evildragon::OclRxJitRunner::loadAsmProgram()
{
