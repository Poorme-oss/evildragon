...
rapidjson::Value evildragon::CudaConfig::toJSON(rapidjson::Document &doc) const
{
...
std::vector<evildragon::CudaLaunchData> evildragon::CudaConfig::get(const Miner *miner, const Algorithm &algorithm, const std::vector<CudaDevice> &devices) const
{
...
void evildragon::CudaConfig::read(const rapidjson::Value &value)
{
    if (value.IsObject()) {
...
void evildragon::CudaConfig::generate()
{
    if (generated) {
        return;
    }
...
void evildragon::CudaConfig::setDevicesHint(const char *devicesHint)
{
