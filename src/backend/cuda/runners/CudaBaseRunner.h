...
#ifndef evildragon_CUDABASERUNNER_H
#define evildragon_CUDABASERUNNER_H
...
{
public:
    evildragon_DISABLE_COPY_MOVE_DEFAULT(CudaBaseRunner)
...
#endif // evildragon_CUDABASERUNNER_H
