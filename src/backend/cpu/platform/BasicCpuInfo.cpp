 ...
 * Copyright 2016-2020 evildragon       <support@evildragon.com>
 *
...
int cpu_flags_has_avx2()    { return evildragon::has_avx2(); }
int cpu_flags_has_avx512f() { return evildragon::has_avx512f(); }
int cpu_flags_has_sse2()    { return evildragon::has_sse2(); }
int cpu_flags_has_ssse3()   { return evildragon::has_ssse3(); }
int cpu_flags_has_xop()     { return evildragon::has_xop(); }
...
evildragon::BasicCpuInfo::BasicCpuInfo() :
...
const char *evildragon::BasicCpuInfo::backend() const
{
    return "basic/1";
}


evildragon::CpuThreads evildragon::BasicCpuInfo::threads(const Algorithm &algorithm, uint32_t) const
{
...
rapidjson::Value evildragon::BasicCpuInfo::toJSON(rapidjson::Document &doc) const
{
