...
evildragon::CpuThreads::CpuThreads(const rapidjson::Value &value)
{
    if (value.IsArray()) {
...
evildragon::CpuThreads::CpuThreads(size_t count, uint32_t intensity)
{
...
bool evildragon::CpuThreads::isEqual(const CpuThreads &other) const
{
...
rapidjson::Value evildragon::CpuThreads::toJSON(rapidjson::Document &doc) const
{
