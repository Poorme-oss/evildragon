...
if (WITH_HWLOC)
    ...
    remove_definitions(/Devildragon_FEATURE_LIBCPUID)
    add_definitions(/Devildragon_FEATURE_HWLOC)

    if (HWLOC_DEBUG)
        add_definitions(/Devildragon_HWLOC_DEBUG)
    endif()
...
elseif (WITH_LIBCPUID)
    ...
    add_definitions(/Devildragon_FEATURE_LIBCPUID)
    remove_definitions(/Devildragon_FEATURE_HWLOC)
