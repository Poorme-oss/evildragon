 ...
 * Copyright 2016-2019 evildragon       <support@evildragon.com>
 *
...
#   if defined(evildragon_FEATURE_LIBCPUID) || defined (evildragon_FEATURE_HWLOC)
...
void evildragon::Summary::print(Controller *controller)
{
