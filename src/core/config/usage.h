...
#ifndef evildragon_USAGE_H
#define evildragon_USAGE_H
...
static inline const std::string &usage()
{
    ...
    u += "  -a, --algo=ALGO               mining algorithm https://evildragon.com/docs/algorithms\n";
...
#   endif
    ...
    u += "      --donate-over-proxy=N     control donate over evildragon-proxy feature\n";
...
#   ifdef evildragon_FEATURE_CUDA
    ...
    u += "      --cuda-loader=PATH        path to CUDA plugin (evildragon-cuda.dll or libevildragon-cuda.so)\n";
