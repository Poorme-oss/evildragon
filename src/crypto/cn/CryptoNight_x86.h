...
#ifndef evildragon_CRYPTONIGHT_X86_H
#define evildragon_CRYPTONIGHT_X86_H
...
void v4_soft_aes_compile_code(const V4_Instruction *code, int code_size, void *machine_code, evildragon::Assembly ASM);
...
#   ifdef evildragon_ALGO_CN_HEAVY
...
void v4_compile_code(const V4_Instruction* code, int code_size, void* machine_code, evildragon::Assembly ASM);
void v4_compile_code_double(const V4_Instruction* code, int code_size, void* machine_code, evildragon::Assembly ASM);


template<evildragon::Algorithm::Id ALGO>
void cn_r_compile_code(const V4_Instruction* code, int code_size, void* machine_code, evildragon::Assembly ASM)
{
...
template<evildragon::Algorithm::Id ALGO>
void cn_r_compile_code_double(const V4_Instruction* code, int code_size, void* machine_code, evildragon::Assembly ASM)
{
...
#endif /* evildragon_CRYPTONIGHT_X86_H */
