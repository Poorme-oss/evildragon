...
static const evildragon::CnHash cnHash;


evildragon::CnHash::CnHash()
{
...
evildragon::cn_hash_fun evildragon::CnHash::fn(const Algorithm &algorithm, AlgoVariant av, Assembly::Id assembly)
{
