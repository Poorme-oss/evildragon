...
bool evildragon::LinuxMemory::reserve(size_t size, uint32_t node, bool oneGbPages)
{
...
bool evildragon::LinuxMemory::write(const char *path, uint64_t value)
{
...
int64_t evildragon::LinuxMemory::read(const char *path)
{
