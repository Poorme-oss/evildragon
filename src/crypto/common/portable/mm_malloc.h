...
#ifndef evildragon_MM_MALLOC_PORTABLE_H
#define evildragon_MM_MALLOC_PORTABLE_H


#if defined(evildragon_ARM) && !defined(__clang__)
#include <stdlib.h>
...
#endif /* evildragon_MM_MALLOC_PORTABLE_H */
