...
evildragon::Assembly::Id evildragon::Assembly::parse(const char *assembly, Id defaultValue)
{
...
evildragon::Assembly::Id evildragon::Assembly::parse(const rapidjson::Value &value, Id defaultValue)
{
    if (value.IsBool()) {
...
const char *evildragon::Assembly::toString() const
{
    return asmNames[m_id];
}


rapidjson::Value evildragon::Assembly::toJSON() const
{
