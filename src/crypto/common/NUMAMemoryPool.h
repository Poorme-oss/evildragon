...
#ifndef evildragon_NUMAMEMORYPOOL_H
#define evildragon_NUMAMEMORYPOOL_H
...
{
public:
    evildragon_DISABLE_COPY_MOVE_DEFAULT(NUMAMemoryPool)
...
#endif /* evildragon_NUMAMEMORYPOOL_H */
