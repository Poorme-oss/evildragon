...
void *evildragon::VirtualMemory::allocateOneGbPagesMemory(size_t)
{
    return nullptr;
}
...
void evildragon::VirtualMemory::freeLargePagesMemory(void *p, size_t)
{
...
void evildragon::VirtualMemory::osInit(bool hugePages)
{
    if (hugePages) {
