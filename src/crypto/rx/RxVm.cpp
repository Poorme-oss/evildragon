...
randomx_vm* evildragon::RxVm::create(RxDataset *dataset, uint8_t *scratchpad, bool softAes, evildragon::Assembly assembly, uint32_t node)
{
    int flags = 0;
...
void evildragon::RxVm::destroy(randomx_vm* vm)
{
    if (vm) {
