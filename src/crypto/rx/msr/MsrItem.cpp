...
evildragon::MsrItem::MsrItem(const rapidjson::Value &value)
{
    if (!value.IsString()) {
        return;
    }
...
rapidjson::Value evildragon::MsrItem::toJSON(rapidjson::Document &doc) const
{
    return toString().toJSON(doc);
}


evildragon::String evildragon::MsrItem::toString() const
{
