...
evildragon::Algorithm::Id evildragon::RxAlgo::apply(Algorithm::Id algorithm)
{
...
const RandomX_ConfigurationBase *evildragon::RxAlgo::base(Algorithm::Id algorithm)
{
    switch (algorithm) {
...
uint32_t evildragon::RxAlgo::version(Algorithm::Id algorithm)
{
    return algorithm == Algorithm::RX_WOW ? 103 : 104;
}


uint32_t evildragon::RxAlgo::programCount(Algorithm::Id algorithm)
{
    return base(algorithm)->ProgramCount;
}


uint32_t evildragon::RxAlgo::programIterations(Algorithm::Id algorithm)
{
    return base(algorithm)->ProgramIterations;
}


uint32_t evildragon::RxAlgo::programSize(Algorithm::Id algorithm)
{
