...
#ifndef evildragon_DONATESTRATEGY_H
#define evildragon_DONATESTRATEGY_H
...
{
public:
    evildragon_DISABLE_COPY_MOVE_DEFAULT(DonateStrategy)
...
#endif /* evildragon_DONATESTRATEGY_H */
