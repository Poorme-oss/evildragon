...
evildragon::Network::Network(Controller *controller) :
...
void evildragon::Network::connect()
{
    m_strategy->connect();
}


void evildragon::Network::execCommand(char command)
{
    switch (command) {
    case 's':
    case 'S':
...
void evildragon::Network::onActive(IStrategy *strategy, IClient *client)
{
...
void evildragon::Network::onConfigChanged(Config *config, Config *previousConfig)
{
...
void evildragon::Network::onJob(IStrategy *strategy, IClient *client, const Job &job, const rapidjson::Value &)
{
...
void evildragon::Network::onJobResult(const JobResult &result)
{
...
void evildragon::Network::onLogin(IStrategy *, IClient *client, rapidjson::Document &doc, rapidjson::Value &params)
{
...
void evildragon::Network::onPause(IStrategy *strategy)
{
    if (m_donate && m_donate == strategy) {
...
void evildragon::Network::onResultAccepted(IStrategy *, IClient *, const SubmitResult &result, const char *error)
{
...
void evildragon::Network::onVerifyAlgorithm(IStrategy *, const IClient *, const Algorithm &algorithm, bool *ok)
{
...
#ifdef evildragon_FEATURE_API
void evildragon::Network::onRequest(IApiRequest &request)
{
...
void evildragon::Network::setJob(IClient *client, const Job &job, bool donate)
{
...
#ifdef evildragon_FEATURE_API
void evildragon::Network::getConnection(rapidjson::Value &reply, rapidjson::Document &doc, int version) const
{
    using namespace rapidjson;
    auto &allocator = doc.GetAllocator();
...
void evildragon::Network::getResults(rapidjson::Value &reply, rapidjson::Document &doc, int version) const
{
    using namespace rapidjson;
    auto &allocator = doc.GetAllocator();
