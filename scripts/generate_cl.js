...
function cn()
{
    ...
    fs.writeFileSync('cryptonight_cl.h', text2h(cn, 'evildragon', 'cryptonight_cl'));
}
...
function cn_r()
{
    ...
    fs.writeFileSync('cryptonight_r_cl.h', text2h_bundle('evildragon', items));
}
...
function rx()
{
    ...
    fs.writeFileSync('randomx_cl.h', text2h(rx, 'evildragon', 'randomx_cl'));
}
...
function astrobwt()
{
    ...
    fs.writeFileSync('astrobwt_cl.h', text2h(astrobwt, 'evildragon', 'astrobwt_cl'));
}
...
function kawpow()
{
    ...
    fs.writeFileSync('kawpow_cl.h', text2h(kawpow, 'evildragon', 'kawpow_cl'));
    fs.writeFileSync('kawpow_dag_cl.h', text2h(kawpow_dag, 'evildragon', 'kawpow_dag_cl'));
}
