if (WITH_RANDOMX)
    add_definitions(/Devildragon_ALGO_RANDOMX)
    set(WITH_ARGON2 ON)
    ...
    elseif (NOT evildragon_ARM AND CMAKE_SIZEOF_VOID_P EQUAL 8)
        list(APPEND SOURCES_CRYPTO
    ...
    elseif (evildragon_ARM AND CMAKE_SIZEOF_VOID_P EQUAL 8)
        list(APPEND SOURCES_CRYPTO
    ...
    if (WITH_MSR AND NOT evildragon_ARM AND CMAKE_SIZEOF_VOID_P EQUAL 8 AND (evildragon_OS_WIN OR evildragon_OS_LINUX))
        add_definitions(/Devildragon_FEATURE_MSR)
        add_definitions(/Devildragon_FIX_RYZEN)
        message("-- WITH_MSR=ON")
        ...
        remove_definitions(/Devildragon_FEATURE_MSR)
        remove_definitions(/Devildragon_FIX_RYZEN)
        message("-- WITH_MSR=OFF")
    endif()
else()
    remove_definitions(/Devildragon_ALGO_RANDOMX)
endif()
