# CMake options
**Recent version of this document: https://evildragon.com/docs/miner/cmake-options**
...
* **`-DWITH_HWLOC=OFF`**
disable [hwloc](https://github.com/evildragon/evildragon/issues/1077) support.
...
* **`-DWITH_EMBEDDED_CONFIG=ON`** Enable [embedded](https://github.com/evildragon/evildragon/issues/957) config support.
...
* **`-Devildragon_DEPS=<path>`** path to precompiled dependencies https://github.com/evildragon/evildragon-deps
